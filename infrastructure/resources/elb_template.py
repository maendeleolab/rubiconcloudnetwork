...
# This function deploys a target group and a load balancer
# The target gets associated to the load balancer
def deploy_elb(
	targets_name,
	protocol,
	port,
...
# This function creates an additonal target group,
# then associates it to a load balancer
def add_targets(
	elbv2,
	vpc_id,
	target_type,
