...
def delete_all(
    ...
    delete_subnet_resources(get_subnet_id(
        vpc_name+'_public_1a_pri', ec2), ec2)
    delete_subnet_resources(get_subnet_id(
        vpc_name+'_public_1b_pri', ec2), ec2)
    delete_subnet_resources(get_subnet_id(
        vpc_name+'_public_1a_sec', ec2), ec2)
    delete_subnet_resources(get_subnet_id(
        vpc_name+'_public_1b_sec', ec2), ec2)
    delete_subnet_resources(get_subnet_id(
        vpc_name+'_private_1a_pri', ec2), ec2)
    delete_subnet_resources(get_subnet_id(
        vpc_name+'_private_1b_pri', ec2), ec2)
    delete_subnet_resources(get_subnet_id(
        vpc_name+'_private_1a_sec', ec2), ec2)
    delete_subnet_resources(get_subnet_id(
        vpc_name+'_private_1b_sec', ec2), ec2)
    delete_vpc_acl(vpc_name, ec2)
    delete_vpc_route_table(get_vpc_route_table_id(
        vpc_name+'_private_rt_pri_az1', ec2), ec2)
    delete_vpc_route_table(get_vpc_route_table_id(
        vpc_name+'_private_rt_pri_az2', ec2), ec2)
    delete_vpc_route_table(get_vpc_route_table_id(
        vpc_name+'_private_rt_sec_az1', ec2), ec2)
    delete_vpc_route_table(get_vpc_route_table_id(
        vpc_name+'_private_rt_sec_az2', ec2), ec2)
    delete_vpc_route_table(get_vpc_route_table_id(
        vpc_name+'_public_rt_pri', ec2), ec2)
    delete_vpc_route_table(get_vpc_route_table_id(
        vpc_name+'_public_rt_sec', ec2), ec2)
