...
from network_resources.nat_gateway_template import deploy_nat_gateways
...
# Deploys public and private nat gateways in two AZs
deploy_nat_gateways('boto3_vpc1',
                    ec2=client_session('default', 'ec2', 'us-east-1')
                    )
deploy_nat_gateways('boto3_vpc1',
                    ec2=client_session('default', 'ec2', 'us-east-1')
