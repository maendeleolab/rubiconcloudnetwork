...
delete_nat('boto3_public_nat1', ec2)
delete_nat('boto3_public_nat2', ec2)
delete_nat('boto3_private_nat1', ec2)
delete_nat('boto3_private_nat2', ec2)
detach_public_ipv4('boto3_public_nat1', ec2)
detach_public_ipv4('boto3_public_nat2', ec2)
...
release_public_ipv4_address('boto3_public_nat1', ec2)
release_public_ipv4_address('boto3_public_nat2', ec2)
...
delete_vpc_route_table(get_vpc_route_table_id(vpc1+'_private_rt_pri_az1', ec2), ec2)
delete_vpc_route_table(get_vpc_route_table_id(vpc1+'_private_rt_pri_az2', ec2), ec2)
delete_vpc_route_table(get_vpc_route_table_id(vpc1+'_private_rt_sec_az1', ec2), ec2)
delete_vpc_route_table(get_vpc_route_table_id(vpc1+'_private_rt_sec_az2', ec2), ec2)
