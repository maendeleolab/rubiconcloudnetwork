...
def deploy_vpc():
	...
	create_vpc_route_table(get_vpc_id(vpc1, ec2), vpc1+'_private_rt_pri_az1', ec2)
	create_vpc_route_table(get_vpc_id(vpc1, ec2), vpc1+'_private_rt_pri_az2', ec2)
	create_vpc_route_table(get_vpc_id(vpc1, ec2), vpc1+'_private_rt_sec_az1', ec2)
	create_vpc_route_table(get_vpc_id(vpc1, ec2), vpc1+'_private_rt_sec_az2', ec2)
	...
	create_subnet_association_to_route_table(get_vpc_route_table_id(vpc1+'_private_rt_pri_az1', ec2), get_subnet_id(vpc1+'_private_1a_pri', ec2), ec2)
	create_subnet_association_to_route_table(get_vpc_route_table_id(vpc1+'_private_rt_pri_az2', ec2), get_subnet_id(vpc1+'_private_1b_pri', ec2), ec2)
	create_subnet_association_to_route_table(get_vpc_route_table_id(vpc1+'_private_rt_sec_az1', ec2), get_subnet_id(vpc1+'_private_1a_sec', ec2), ec2)
	create_subnet_association_to_route_table(get_vpc_route_table_id(vpc1+'_private_rt_sec_az2', ec2), get_subnet_id(vpc1+'_private_1b_sec', ec2), ec2)
